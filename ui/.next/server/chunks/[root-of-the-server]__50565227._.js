...
async function register() {
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            const sourceMapSupport = await __turbopack_context__.r("[project]/node_modules/source-map-support/source-map-support.js [instrumentation] (ecmascript, async loader)")(__turbopack_context__.i);
