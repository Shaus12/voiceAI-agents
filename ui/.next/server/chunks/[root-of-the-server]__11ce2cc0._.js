...
"[project]/node_modules/source-map-support/source-map-support.js [instrumentation] (ecmascript, async loader)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/node_modules_89a01cec._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/node_modules/source-map-support/source-map-support.js [instrumentation] (ecmascript)");
    });
});
}}),
