            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600">Manage your API keys to access VoiceFX AI services programmatically</p>
                    </div>
                    ...
                    {/* VoiceFX AI Service Keys Section */}
                    <Card className="mb-6">
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    <CardTitle>VoiceFX AI Service Keys</CardTitle>
                                    <CardDescription>
                                        Manage service keys for accessing VoiceFX AI AI services (LLM, TTS, STT)
                                    </CardDescription>
                                </div>
                                <div className="flex gap-2">
            ...
            <Dialog open={isCreateServiceDialogOpen} onOpenChange={setIsCreateServiceDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create a service key to access VoiceFX AI AI services (LLM, TTS, STT)
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                <p className="text-sm text-blue-800">
                                    This key provides access to VoiceFX AI AI services including LLM, Text-to-Speech, and Speech-to-Text.
