            ...
            <div>
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-gray-600">Monitor your VoiceFX AI Token usage and quota</p>
                    </div>
                                    ...
                                    <div>
                                        {organizationPricing?.price_per_second_usd ? (
                                            ...
                                            <>
                                                ...
                                                <p className="text-sm text-gray-600">VoiceFX AI Tokens</p>
                                            </>
                                        )}
                                    </div>
                                    {!organizationPricing?.price_per_second_usd && (
                                        ...
                                        <TableHeader>
                                            <TableRow className="bg-gray-50">
                                                ...
                                                <TableHead className="font-semibold text-right">
                                                    {organizationPricing?.price_per_second_usd ? 'Cost (USD)' : 'VoiceFX AI Tokens'}
                                                </TableHead>
                                    ...
                                    <div className="mt-4 p-3 bg-gray-50 rounded-md">
                                        <p className="text-sm text-gray-600">
                                            Total for filtered period: <span className="font-semibold text-gray-900">
                                                {usageHistory.total_dograh_tokens.toLocaleString()} VoiceFX AI Tokens
                                            </span>
                                            {' • '}
