...
class OrganizationUsageCycleModel(Base):
    """
    This model is used to track the usage of VoiceFX AI tokens for an organization for a given usage
    cycle.
    """
    ...
    quota_voicefx_tokens = Column(Integer, nullable=False)
    used_voicefx_tokens = Column(Float, nullable=False, default=0)
