...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("quota_voicefx_tokens", sa.Integer(), nullable=False),
        sa.Column("used_voicefx_tokens", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_column("organizations", "quota_voicefx_tokens")
