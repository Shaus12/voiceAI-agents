...
This module implements the telephony provider abstraction for voiceFX AI. For user-facing documentation, see the [Mintlify docs](https://docs.voicefx.com/integrations/telephony/overview).
...
See the [Custom Provider Guide](https://docs.voicefx.com/integrations/telephony/custom) in the documentation for detailed implementation instructions.
...
- [User Documentation](https://docs.voicefx.com/integrations/telephony/overview)
- [Twilio Integration](https://docs.voicefx.com/integrations/telephony/twilio)
- [Custom Providers](https://docs.voicefx.com/integrations/telephony/custom)
- [Webhooks Guide](https://docs.voicefx.com/integrations/telephony/webhooks)