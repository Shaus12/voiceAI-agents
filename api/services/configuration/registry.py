...
# voiceFX LLM Service
class VoiceFXLLMModel(str, Enum):
    DEFAULT = "default"
    FAST = "fast"
    ACCURATE = "accurate"
...
@register_llm
class VoiceFXLLMService(BaseLLMConfiguration):
    provider: Literal[ServiceProviders.VOICEFX] = ServiceProviders.VOICEFX
    model: VoiceFXLLMModel = VoiceFXLLMModel.DEFAULT
    api_key: str
...
# voiceFX TTS Service
class VoiceFXVoice(str, Enum):
    DEFAULT = "default"
    JOEY = "joey"
    RACHEL = "rachel"


class VoiceFXTTSModel(str, Enum):
    DEFAULT = "default"


@register_tts
class VoiceFXTTSService(BaseTTSConfiguration):
    provider: Literal[ServiceProviders.VOICEFX] = ServiceProviders.VOICEFX
    model: VoiceFXTTSModel = VoiceFXTTSModel.DEFAULT
    voice: VoiceFXVoice = VoiceFXVoice.DEFAULT
    api_key: str
...
# voiceFX STT Service
class VoiceFXSTTModel(str, Enum):
    DEFAULT = "default"


@register_stt
class VoiceFXSTTService(BaseSTTConfiguration):
    provider: Literal[ServiceProviders.VOICEFX] = ServiceProviders.VOICEFX
    model: VoiceFXSTTModel = VoiceFXSTTModel.DEFAULT
    api_key: str


STTConfig = Annotated[
    Union[DeepgramSTTConfiguration, OpenAISTTConfiguration, VoiceFXSTTService],
    Field(discriminator="provider"),
]
