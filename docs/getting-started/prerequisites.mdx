---
title: "Prerequisites"
description: "System requirements and setup needed to run VoiceFX AI AI locally"
---
...
To run VoiceFX AI AI locally, make sure you have the following installed:
...
VoiceFX AI images are available from two registries:
