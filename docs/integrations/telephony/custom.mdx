...
description: "Build your own telephony provider integration for voiceFX AI"
---

## Overview

voiceFX AI's telephony abstraction layer allows you to integrate any telephony service by implementing the `TelephonyProvider` interface.
