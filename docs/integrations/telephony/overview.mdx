...
voiceFX AI's telephony integration system provides a unified interface for connecting with various telephony providers. This abstraction layer allows you to easily switch between providers without changing your application logic.
...
voiceFX AI uses database configuration for all telephony providers. Configure providers through the web interface:
...
The telephony integration in voiceFX AI supports:
