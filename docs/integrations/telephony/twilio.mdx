...
description: "Configure Twilio for voice communication in voiceFX AI"
---

## Overview

Twilio is a cloud communications platform that enables voice calling, messaging, and video capabilities. voiceFX AI's Twilio integration provides seamless connectivity for your voice agents.
...
### Step 2: Configure in voiceFX AI
...
### Outbound Calling
When you initiate a call through voiceFX AI:
