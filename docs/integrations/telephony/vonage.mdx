...
description: "Configure Vonage (Nexmo) for voice communication in voiceFX AI"
---

## Overview

Vonage (formerly Nexmo) is a cloud communications platform that provides global voice, messaging, and video capabilities. voiceFX AI's Vonage integration enables high-quality voice interactions with your agents using Vonage's robust infrastructure.
...
- voiceFX AI instance running and accessible

## Video Tutorial

Watch this step-by-step guide to set up Vonage with voiceFX AI:
...
### Step 3: Configure in voiceFX AI
...
1. voiceFX AI generates a JWT token using your private key
2. Call is initiated via Vonage Voice API
3. Vonage requests NCCO instructions at the webhook URL
4. VoiceFX AI returns WebSocket connection details
